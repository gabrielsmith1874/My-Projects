...
class CSP:
    ...
    def __init__(self, name, variables, constraints):
        ...
        self._name = name
        self._variables = list(variables)  # Convert to list
        ...
        self.constraints_of = [[] for i in range(len(self._variables))]
        for c in constraints:
            for v in c.scope():
                i = self._variables.index(v)  # Use the list version of variables
