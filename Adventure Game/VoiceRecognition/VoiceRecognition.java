...
public class VoiceRecognition {
     ...
     */
    public synchronized void startSpeechRecognition(AdventureGame model, AdventureGameView adventureGameView) {
                    ...
                    while (speechRecognizerThreadRunning.get()) {
                        ...
                        if (!ignoreSpeechRecognitionResults.get()) {
                            ...
                            if (speechResult == null)
                                ...
                                adventureGameView.processVoiceCommand(speechRecognitionResult.strip().toUpperCase());
                            }
                        } else
